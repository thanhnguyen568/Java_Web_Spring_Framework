...
@Configuration
@ComponentScan("baitap.ss6_jpa")
@EnableWebMvc
@EnableTransactionManagement
@EnableJpaRepositories("baitap.ss6_jpa.repository")
...
//    }
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        entityManagerFactory.setPackagesToScan("baitap.ss6_jpa");
